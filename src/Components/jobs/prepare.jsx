    ...
    return (
        <div className={styles.ways}>
            <div className={styles.prepare}>
                ...
                <div>
                    <div>
                        <img src="https://png.pngtree.com/png-vector/20190820/ourlarge/pngtree-light-bulb-icon-vector--light-bulb-ideas-symbol-illustration-png-image_1694700.jpg" alt="" />
                    </div>
                    <div>
