...
export default function Navbar() {
    return (
        <NavCont>
            <NavIn>
                <Logo>
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 34 34" class="global-nav__logo">
                        <title>
                            LinkedIn
                        </title>
                        <g>
                ...
                <Search>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="#666666" class="mercado-match" width="30" height="30" focusable="false">
